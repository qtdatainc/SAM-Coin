...
This document provides guidelines for internationalization of the Samcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `samcoin_en.ts` remains unchanged.
