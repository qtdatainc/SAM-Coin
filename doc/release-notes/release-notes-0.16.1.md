Samcoin Core version 0.16.1 is now available from:

  <https://samcoincore.org/bin/samcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting samcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure samcoind processes are cleaned up when tests end (sdaftuar)
