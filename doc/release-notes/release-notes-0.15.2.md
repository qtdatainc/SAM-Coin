Samcoin Core version *0.15.2* is now available from:

  <https://samcoincore.org/bin/samcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in samcoin-tx (TheBlueMatt)
