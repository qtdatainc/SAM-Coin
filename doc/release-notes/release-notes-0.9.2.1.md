Samcoin Core version 0.9.2.1 is now available from:

  https://samcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SAM to 0.01 SAM
...
- Fix "Start samcoin on system login"
