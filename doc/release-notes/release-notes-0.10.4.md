Samcoin Core version 0.10.4 is now available from:

  <https://samcoin.org/bin/samcoin-core-0.10.4/>
...
- #6953 `43c2789` Split samcoin-tx into its own package
- #6953 `dfe0d4d` Include samcoin-tx binary on Debian/Ubuntu
