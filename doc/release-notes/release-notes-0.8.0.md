Samcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/samcoin/files/Samcoin/samcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Samcoin
...
New/changed settings (command-line or samcoin.conf file)
--------------------------------------------------------
