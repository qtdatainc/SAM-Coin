...
Samcoin Core version 0.19.1 is now available from:

  <https://samcoincore.org/bin/samcoin-core-0.19.1/>
...
From Samcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Samcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Samcoin Core does not yet change appearance when
...
- #17488 fix "samcoind already running" warnings on macOS (fanquake)
