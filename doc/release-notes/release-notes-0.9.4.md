Samcoin Core version 0.9.4 is now available from:

  https://samcoin.org/bin/0.9.4/
...
this update is incompatible with the Samcoin system and could lead to consensus
forks.

Samcoin Core released binaries from https://samcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~samcoin/+archive/ubuntu/samcoin
- A third-party or self-compiled Samcoin Core

upgrade to Samcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
