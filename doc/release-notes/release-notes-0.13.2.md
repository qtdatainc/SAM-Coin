Samcoin Core version 0.13.2 is now available from:

  <https://samcoin.org/bin/samcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update samcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow samcoin-tx to create v2 transactions (samdrak)
