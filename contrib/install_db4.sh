#!/bin/sh
# Copyright (c) 2017-2019 The Samcoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the samcoin repository."
  exit 1
fi
...
# See https://github.com/samcoin/samcoin/issues/16064
...
echo 'When compiling samcoind, run `./configure` in the following way:'
echo
