...
(define* (make-samcoin-cross-toolchain target
                                       #:key
...
desirable for building Samcoin Core release binaries."
...
(define glibc-2.27/samcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-samcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/samcoin-patched
