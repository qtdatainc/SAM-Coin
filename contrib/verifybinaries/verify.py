...
samcoincore.org and samcoin.org and compares them.
...
WORKINGDIR = "/tmp/samcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://samcoincore.org"
HOST2 = "https://samcoin.org"
VERSIONPREFIX = "samcoin-core-"
...
def main(args):
    ...
    if not success:
        print("samcoin.org failed to provide signature file, "
              "but samcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("samcoin.org and samcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Samcoin Core binary release "
