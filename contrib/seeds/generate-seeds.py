...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef SAMCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define SAMCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the samcoin network\n')
    ...
    g.write('#endif // SAMCOIN_CHAINPARAMSSEEDS_H\n')
