...
#ifndef SAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define SAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Samcoin Core wallet was originally a collection of unrelated private
...
#endif // SAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
