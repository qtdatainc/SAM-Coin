...
#ifndef SAMCOIN_WALLET_WALLETUTIL_H
#define SAMCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! samcoin from opening the wallet, thinking it was newly created, and
...
#endif // SAMCOIN_WALLET_WALLETUTIL_H
