...
#ifndef SAMCOIN_TEST_SCRIPTNUM10_H
#define SAMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Samcoin Core 0.10.0, for cross-comparison.
 */
public:
