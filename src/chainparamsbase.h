...
#ifndef SAMCOIN_CHAINPARAMSBASE_H
#define SAMCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between samcoin-cli and samcoind)
 * of a given instance of the Samcoin system.
 */
...
#endif // SAMCOIN_CHAINPARAMSBASE_H
