...
#ifndef SAMCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define SAMCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@samcoin.
 *
 ...
 *
 * The chacha20-poly1305@samcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@samcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@samcoin are relatively fast in
...
#endif // SAMCOIN_CRYPTO_CHACHA_POLY_AEAD_H
