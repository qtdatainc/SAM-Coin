...
#ifndef SAMCOIN_COMPAT_ASSUMPTIONS_H
#define SAMCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Samcoin cannot be compiled without assertions."
#endif
...
#endif // SAMCOIN_COMPAT_ASSUMPTIONS_H
