...
#ifndef SAMCOIN_INTERFACES_INIT_H
#define SAMCOIN_INTERFACES_INIT_H
...
//! (samcoin-gui, samcoin-node, samcoin-wallet, samcoind, samcoin-qt) and each
...
#endif // SAMCOIN_INTERFACES_INIT_H
