...
#ifndef SAMCOIN_INTERFACES_NODE_H
#define SAMCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a samcoin node (samcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // SAMCOIN_INTERFACES_NODE_H
