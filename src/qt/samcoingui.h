...
#ifndef SAMCOIN_QT_SAMCOINGUI_H
#define SAMCOIN_QT_SAMCOINGUI_H
...
/**
  Samcoin GUI main class. This class represents the main window of the Samcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SamcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SamcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SamcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a samcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Samcoin Transaction from file or clipboard */
