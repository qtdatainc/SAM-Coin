    ...
    platformStyle(_platformStyle)
{
    ...
    // normal samcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying samcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &SamcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
