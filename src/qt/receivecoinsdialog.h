...
#ifndef SAMCOIN_QT_RECEIVECOINSDIALOG_H
#define SAMCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of samcoins */
...
#endif // SAMCOIN_QT_RECEIVECOINSDIALOG_H
