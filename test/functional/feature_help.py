...
"""Verify that starting samcoin with -h works as expected."""

from test_framework.test_framework import SamcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(SamcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start samcoin with -h for help text")
        ...
        self.log.info("Start samcoin with -version for version information")
        ...
        self.log.info("Start samcoind with -fakearg to make sure it does not start")
