...
class TestShell:
    """Wrapper Class for SamcoinTestFramework.

    The TestShell class extends the SamcoinTestFramework
    ...
    class __TestShell(SamcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SamcoinTestFramework child class.
            self.num_nodes = 1
