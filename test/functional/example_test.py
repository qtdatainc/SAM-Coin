...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SamcoinTestFramework
    pass


class ExampleTest(SamcoinTestFramework):
    # Each functional test is a subclass of the SamcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SamcoinTestFramework class so other tests can use it."""
