...
class VersionBitsWarningTest(SamcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because samcoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
