...
By default, samcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SamcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent samcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
