...
"""
Test starting samcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(SamcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that samcoind has bound on "::1" (for RPC) and "::" (for P2P).
