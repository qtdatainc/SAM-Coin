...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Samcoin
else
  DOCKER_EXEC echo \> \$HOME/.samcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/samcoin/samcoin/pull/18288#discussion_r433189350 for
  # details.
